...
// Extended student interface with User relation
interface IStudentWithRelations extends IStudent {
  User?: {
    id: string;
    name: string;
    email: string;
...
export function StudentDetailsView({ item }: StudentDetailsViewProps) {
          ...
          <div className="space-y-2">
            ...
            <div className="p-3 rounded-lg border border-slate-100 bg-white">
              <div className="flex items-start gap-2">
                <FileText className="h-4 w-4 text-[#00ADB5] shrink-0 mt-0.5" />
